...
xlsx::write.xlsx(
  ...
  file = "data/Table1.xls",
  row.names = FALSE,
  col.names = TRUE
)

useOfInternetMoran <- 
  DataMoran(useOfInternet)
searchesForBiologyMoran <- 
  DataMoran(searchesForBiology)
searchesForChemistryMoran <- 
  DataMoran(searchesForChemistry)
searchesForMathematicsMoran <- 
  DataMoran(searchesForMathematics)
searchesForGloboMoran <- 
  DataMoran(searchesForGlobo)
searchesForGamesMoran <- 
  DataMoran(searchesForGames)
