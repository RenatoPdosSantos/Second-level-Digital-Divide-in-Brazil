...
---
##Abstract
While the use of the Internet became ubiquitous in students' lives, mainly for entertainment purposes, access in schools has been drastically reduced in Brazil. Unlike previous studies, this research used choropleth maps to analyze graphically the actual usage of youth-oriented educational and entertainment websites in Brazil in the period 2005-2015 by region and social class to veri-fy whether the increasing Internet access helps to reproduce or close those educational inequalities. Results suggest that by removing the much-needed cultivation of the technological capital in its students, the school system in Brazil is failing to play its crucial role in helping reduce the widening of a second-level digital divide. Brazilian policymakers should incentivize school-based digital activities and behaviors that promote more productive Internet uses.
##Keywords: Brazil, Google Trends, Internet access, Second-level Digital Divide, Web searches studies
...
# silentLoad("basicTrendline") # Add Trendline and Confidence Interval of Basic Regression Models to Plot
silentLoad("Cairo") # Library for  high-quality output
# silentLoad("colorRamps") # Buplyilds color tables
# silentLoad("cowplot")  # Streamlined plot theme and plot annotations for 'ggplot2'
# silentLoad("descr") # Descriptive Statistics
# silentLoad("dplyr") # A grammar of data manipulation
...
# silentLoad("ggpubr") # Arrange multiple ggplots on the same page
# silentLoad("gridExtra") # Arrange multiple grid-based plots on a page, and draw tables
...
# silentLoad("stats") #  Functions for statistical calculations
# silentLoad("tidyr") # Data tidying
...
save.image("~/My Work/Meus trabalhos/Computers & Education/Evidence of a Second-level Digital Divide/.RData")
